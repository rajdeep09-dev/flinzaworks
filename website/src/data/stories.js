...
export const founderStories = [
  {
    ...
    items: [
      { kind: 'image', image: { src: '/images/story_portrait.webp', alt: 'Product still from a client shoot' }, durationMs: 4600, aspect: '9:16', caption: 'Day 40 in the account.' },
  ...
  },
  {
    ...
    title: 'DTC Apparel',
    time: '5h',
    image: { src: '/images/story_traffic.webp', alt: 'Traffic dashboard from a live account' },
    items: [
      { kind: 'image', image: { src: '/images/story_traffic.webp', alt: 'Traffic dashboard from a live account' }, durationMs: 4600, aspect: '9:16' },
  ...
  },
  {
    ...
    title: 'StillRing',
    time: '1d',
    image: { src: '/images/story_portrait.webp', alt: 'Product still from the StillRing campaign' },
    items: [
      { kind: 'image', image: { src: '/images/story_action.webp', alt: 'Production still' }, durationMs: 4600, aspect: '9:16' },
