...
/* While a case study is open the carousel must own the whole viewport. On a phone the lock box is
 * only 62vh tall (it is capped so the cards sit above the pinned CTA), and the focused stage is
 * absolutely positioned inside it — so the case study, and the client quote at the bottom of it,
 * were rendered into a letterbox in the middle of the screen. `is-focused` releases the box to
 * full screen, which is what globals.css keys off. */
const viewportLockClass = focused ? "flinza-carousel-lock is-focused" : "flinza-carousel-lock";
